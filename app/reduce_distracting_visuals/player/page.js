    ...
    return (
        <div className="bg-black py-4 h-screen text-white text-center grid m-auto">
            ...
            <div className="mx-auto w-3/5 py-4 text-center grid grid-cols-1 grid-rows-1">
                ...
                <video id="blurred" ref={videoRef2} controls muted src={`/${video}/${video}.mp4`} type="video/mp4" className={`h-full mx-auto col-start-1 row-start-1 ${reduceVisuals ? "z-20" : "z-0"}`} />
            </div>
